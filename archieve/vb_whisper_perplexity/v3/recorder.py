...
class AudioRecorder:
    def __init__(self, queue, save_dir, device_id=None, source_label="default", silence_threshold=0.0005, silence_duration=0.5, min_speech_duration=0.5, manual_save_event=None):
        self.fs = 16000
        self.buffer = []
        self.queue = queue
